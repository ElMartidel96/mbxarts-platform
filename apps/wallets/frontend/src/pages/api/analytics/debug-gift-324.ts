/**
 * DEBUG ENDPOINT: Check Redis data for gift #324
 * Verifies why claim data not showing in analytics
 */
...
export default async function handler(
  ...
  try {
    ...
    if (!results.summary.hasGiftDetail) {
      ...
      results.summary.diagnosis = 'ERROR: gift:detail exists but NO claimer field';
