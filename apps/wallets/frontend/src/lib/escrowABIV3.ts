 ...
 * - NINETY_DAYS, ONE_YEAR constants
 * - PERPETUAL_EXPIRY, PERPETUAL_MIN_WAIT constants
 * - giftCreatedAt mapping
 * - cancelPerpetualGift function
 * - emergencyCancelGift function
 * - isGiftPerpetual view function
 *
...
export const ESCROW_ABI_V3 = [
  ...
  // V3: Perpetual constants
  {
    "type": "function",
    "name": "PERPETUAL_EXPIRY",
    "inputs": [],
  ...
  // V3: Cancel perpetual gift
  {
    "type": "function",
    "name": "cancelPerpetualGift",
    "inputs": [{"name": "giftId", "type": "uint256", "internalType": "uint256"}],
    "outputs": [],
    "stateMutability": "nonpayable"
  },
  // V3: Emergency cancel (admin)
  {
    "type": "function",
    "name": "emergencyCancelGift",
    "inputs": [{"name": "giftId", "type": "uint256", "internalType": "uint256"}],
    "outputs": [],
    "stateMutability": "nonpayable"
  },
  ...
  // V3: Check if gift is perpetual
  {
    "type": "function",
    "name": "isGiftPerpetual",
    "inputs": [{"name": "giftId", "type": "uint256", "internalType": "uint256"}],
    "outputs": [{"name": "", "type": "bool", "internalType": "bool"}],
    "stateMutability": "view"
  },
  ...
  // V3: Perpetual cancel event
  {
    "type": "event",
    "name": "PerpetualGiftCancelled",
    "inputs": [
      {"name": "giftId", "type": "uint256", "indexed": true, "internalType": "uint256"},
      {"name": "creator", "type": "address", "indexed": true, "internalType": "address"},
      {"name": "timestamp", "type": "uint256", "indexed": false, "internalType": "uint256"}
  ...
  {
    "type": "error",
    "name": "NotPerpetualGift",
    "inputs": [{"name": "giftId", "type": "uint256", "internalType": "uint256"}]
  },
  {
    "type": "error",
    "name": "PerpetualWaitNotMet",
    "inputs": [
      {"name": "giftId", "type": "uint256", "internalType": "uint256"},
      {"name": "createdAt", "type": "uint256", "internalType": "uint256"},
      {"name": "minCancelTime", "type": "uint256", "internalType": "uint256"}
    ]
  },
  {
    "type": "error",
